...
const long interval = 2000;  // Intervalo de lectura de sensores
...
void loop() {
  ...
  if (botonAutomaticoPresionado) {
    if (distance2 >= 10 && distance2 <= 106) {
      if (distance1 >= 110 && distance1 >= 5 && !bombaActivadaSecuencial) {
  ...
  if (botonManualPresionado) {
    if (distance1 > 10 && distance1 >= 5 && distance2 <= 106 && !bombaActivadaManual && distance2 >= 5) {
    ...
    } else if (distance1 <= 10 || distance2 > 106 && bombaActivadaManual) {
    ...
    } else if (distance1 > 10 && distance2 > 106) {
  ...
  if (distance1 <= 10) {
  ...
  } else if (distance1 <= 52.5 && distance1 > 10) {
    ...
    digitalWrite(TL3, LOW);
    digitalWrite(TL4, LOW);
  } else if (distance1 <= 106 && distance1 > 85) {
    digitalWrite(TL1, HIGH);
    digitalWrite(TL2, HIGH);
